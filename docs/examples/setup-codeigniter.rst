...
This example will use ``wget`` to install CodeIgniter from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-ci
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-ci
   blibox@php-7.0.20 in /shared/httpd/my-ci $ wget https://github.com/bcit-ci/CodeIgniter/archive/3.1.8.tar.gz
   blibox@php-7.0.20 in /shared/httpd/my-ci $ tar xfvz 3.1.8.tar.gz

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-ci $ tree -L 1
   .
   ├── 3.1.8.tar.gz
   └── CodeIgniter-3.1.8
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-ci $ ln -s CodeIgniter-3.1.8/ htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-ci $ mysql -u root -h 127.0.0.1 -p -e 'CREATE DATABASE my_ci;'
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-ci $ vi htdocs/application/config/database.php
