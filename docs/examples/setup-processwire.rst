...
This example will use ``composer`` to install ProcessWire from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-pw
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-pw
   blibox@php-7.0.20 in /shared/httpd/my-pw $ composer create-project processwire/processwire

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-pw $ tree -L 1
   .
   └── processwire
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-pw $ ln -s ln -s processwire htdocs
