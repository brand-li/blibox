...
.. code-block:: bash
   ...
   host> cp cfg/vhost-gen/*.yml ./data/www/project-1/.blibox
...
Blibox intranet, because this is the default host when no match has been found.
...
.. code-block:: yaml
   :caption: /home/user/blibox/data/www/project-1/.blibox/apache22.yml
   :emphasize-lines: 3
...
.. code-block:: yaml
   :caption: /home/user/blibox/data/www/project-1/.blibox/nginx.yml
   :emphasize-lines: 4
...
3. When templates are edited, the Blibox is either restarted or the project directory is renamed
