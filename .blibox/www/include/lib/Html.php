...
class Html
{
	...
	public function getHead($font_awesome = false)
	{
		...
		$html = <<<HTML
			...
			<!-- Meta -->
			<meta name="description" content="The blibox - your customizable LAMP/LEMP stack.">
		...
		$html = <<<HTML
			<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse">
				...
				<a class="navbar-brand" href="/index.php">
					<img src="/assets/img/logo.png" width="30" height="30" class="d-inline-block align-top" alt="">blibox
				</a>
			...
			<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse footer">
				<div class="container justify-content-end">
					<ul class="nav navbar-nav">
						...
						<li class="nav-item"><a class="nav-link" target="_blank" href="https://github.com/cytopia/blibox"><code>Github</code></a></li>
