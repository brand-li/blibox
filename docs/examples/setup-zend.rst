...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-zend
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-zend
   blibox@php-7.0.20 in /shared/httpd/my-zend $ composer create-project --prefer-dist zendframework/skeleton-application zend

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-zend $ tree -L 1
   .
   └── zend
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-zend $ ln -s zend/public/ htdocs
