...
.. important::
   ...
   Blibox Auto-vhost generation feature. If you want to custimize your current virtual hosts
   have a look at:
...
.. code-block:: bash
   ...
   host> ls -l path/to/blibox/cfg/ | grep 'apache'
...
``blibox-custom.conf-example``, that can simply be renamed to ``blibox-custom.conf``.
