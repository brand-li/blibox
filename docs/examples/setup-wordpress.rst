...
This example will use ``git`` to install Wordpress from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-wp
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-wp
   blibox@php-7.0.20 in /shared/httpd/my-wp $ git clone https://github.com/WordPress/WordPress wordpress.git

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-wp $ tree -L 1
   .
   └── wordpress.git
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-wp $ ln -s wordpress.git/ htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-wp $ mysql -u root -h 127.0.0.1 -p -e 'CREATE DATABASE my_wp;'
