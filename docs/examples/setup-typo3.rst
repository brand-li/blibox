...
This example will use ``composer`` to install TYPO3 from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-typo
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-typo
   blibox@php-7.0.20 in /shared/httpd/my-typo $ composer create-project typo3/cms-base-distribution typo3

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-typo $ tree -L 1
   .
   └── typo3
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-typo $ ln -s typo3/public htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-typo $ touch htdocs/FIRST_INSTALL
