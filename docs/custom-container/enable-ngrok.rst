...
This section will guide you through getting Ngrok integrated into the Blibox.
...
Copy the Ngrok Docker Compose overwrite file into the root of the Blibox git directory.
...
(the Blibox intranet) to your web server (also named ``httpd``) and makes the admin UI available
...
The final step is to start the Blibox with Ngrok.
...
* Once the Blibox is running, visit http://localhost:4040 in your browser.
