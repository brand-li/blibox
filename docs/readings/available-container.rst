...
These container are well integrated into the Blibox intranet and are considered core container:
...
Additional container that are not yet integrated into the Blibox intranet are also available.
