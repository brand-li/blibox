...
to live code during the showcase the Blibox provides an easy way to accomplish exactly this via
Ngrok.
...
First you want to add Ngrok to the Blibox stack via its pre-defined Docker Compose override file.
