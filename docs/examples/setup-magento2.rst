...
This example will use ``git`` and ``composer`` to install Magento 2 from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.1.20 in /shared/httpd $ mkdir my-magento
...
.. code-block:: bash
   ...
   blibox@php-7.1.20 in /shared/httpd $ cd my-magento

   # Download Magento 2 via git
   blibox@php-7.1.20 in /shared/httpd/my-magento $ git clone https://github.com/magento/magento2

   # Checkout the latest stable git tag
   blibox@php-7.1.20 in /shared/httpd/my-magento $ cd magento2
   blibox@php-7.1.20 in /shared/httpd/my-magento/magento2 $ git checkout 2.2.5

   # Install dependencies with Composer
   blibox@php-7.1.20 in /shared/httpd/my-magento/magento2 $ composer install

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.1.20 in /shared/httpd/my-magento $ tree -L 1
   .
   └── magento2
...
.. code-block:: bash
   ...
   blibox@php-7.1.20 in /shared/httpd/my-magento $ ln -s magento2/ htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.1.20 in /shared/httpd/my-magento $ mysql -u root -h 127.0.0.1 -p -e 'CREATE DATABASE my_magento;'
