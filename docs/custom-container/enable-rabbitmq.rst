...
This section will guide you through getting RabbitMQ integrated into the Blibox.
...
Copy the RabbitMQ Docker Compose overwrite file into the root of the Blibox git directory.
...
The final step is to start the Blibox with RabbitMQ.
