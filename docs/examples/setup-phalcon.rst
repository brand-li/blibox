...
This example will use ``phalcon`` to install Phalcon from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-phalcon
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-phalcon
   blibox@php-7.0.20 in /shared/httpd/my-phalcon $ phalcon project phalconphp

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-phalcon $ tree -L 1
   .
   └── phalconphp
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-phalcon $ ln -s phalconphp/public/ htdocs
...
.. important::
   ...
   * Docker Toolbox and :ref:`howto_docker_toolbox_and_the_blibox_windows_symlinks`
...
In your project folder, you will need to create a folder called .blibox unless you changed `HTTPD_TEMPLATE_DIR` in your .env

Copy the default nginx config from ./cfg/vhost-gen/nginx.yml-example-vhost to ./data/www/my-project/.blibox/nginx.yml
...
save the file as nginx.yml and ensure not to use any tabs in the file or blibox will not use the custom configuration. You can use ``yamllint nginx.yml`` whilst inside the Blibox shell to check the file before restarting blibox.
