...
This section will guide you through getting Blackfire integrated into the Blibox.
...
must be copied into the root of the Blibox git directory.
...
Copy the Blackfire Docker Compose overwrite file into the root of the Blibox git directory.
...
.. code-block:: bash
   ...
   host> cp cfg/php-ini-7.2/blibox-php.ini-blackfire cfg/php-ini-7.2/blackfire.ini
...
The final step is to start the Blibox with Blackfire.
...
Simply copy and paste the following block into your terminal from the root of your Blibox git
directory:
...
.. code-block:: bash
   ...
   cp cfg/php-ini-7.2/blibox-php.ini-blackfire cfg/php-ini-7.2/blackfire.ini
