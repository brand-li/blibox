...
One of the core concepts of the Blibox is to easily change between different versions of a
specific service.
...
Shut down the Blibox in case it is still running:
...
In this example it is ``7.1``, which is the PHP version that will be started, once the Blibox
starts.
...
Now save the file and you can start the Blibox again.
...
Both, PHP 5.5 and PHP 7.0 are uncommented, however, when you start the Blibox, it will use
