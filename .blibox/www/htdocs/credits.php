	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<h2>Contributors</h2>
					<p>The following people have contributed to the <a href="https://github.com/cytopia/blibox/graphs/contributors">Blibox</a>.</p>
					...
					<p>If you like to contribute, have a lookt at the <a href="https://github.com/cytopia/blibox/blob/master/CONTRIBUTING.md">Contributing Guidelines</a>.</p>
				</div>


				<div class="col-md-6">
					<h2>Libraries</h2>
					<p>The <a href="https://github.com/cytopia/blibox">Blibox</a> includes several libraries which are listed below.</p>
					<table class="table table-striped ">
						<thead class="thead-inverse ">
							<tr>
								<th>Vendor</th>
