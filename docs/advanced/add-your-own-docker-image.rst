...
This section is all about customizing the Blibox and its Docker images specifically to your needs.
...
for the Blibox as well as what pitfalls to watch out for.
...
4. ``<unused-ip-address>`` - An unused IP address from the blibox network (found inside ``docker-compose.yml``)
