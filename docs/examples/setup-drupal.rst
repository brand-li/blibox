...
This example will use ``drush`` to install Drupal from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-drupal
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-drupal
   blibox@php-7.0.20 in /shared/httpd/my-drupal $ drush dl drupal

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-drupal $ tree -L 1
   .
   └── drupal-8.3.3
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-drupal $ ln -s drupal-8.3.3/ htdocs
