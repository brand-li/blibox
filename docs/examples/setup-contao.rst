...
This example will use ``composer`` to install Contao CMS from within the Blibox PHP container.
...
+-----------+--------------+------------------------------------------------------------------------------------------------+
| PHP       | PHP-FPM 7.2  | Chosen for this example as it is the Blibox default version                                  |
+-----------+--------------+------------------------------------------------------------------------------------------------+
| Database  | MariaDB 10.3 | Chosen for this example as it is the Blibox default version                                  |
+-----------+--------------+------------------------------------------------------------------------------------------------+
...
.. code-block:: bash
   ...
   blibox@php-7.2.15 in /shared/httpd $ mkdir my-contao
...
.. code-block:: bash
   ...
   blibox@php-7.2.15 in /shared/httpd $ cd my-contao
   blibox@php-7.2.15 in /shared/httpd/my-contao $ composer create-project contao/managed-edition contao

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.2.15 in /shared/httpd/my-contao $ tree -L 1
   .
   └── contao
...
.. code-block:: bash
   ...
   blibox@php-7.2.15 in /shared/httpd/my-contao $ ln -s contao/web/ htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.2.15 in /shared/httpd/my-contao $ mysql -u root -h mysql -p -e 'CREATE DATABASE my_contao;'
...
* Database port: ``3306``
* Database user: ``root``
* Database pass: empty (if not otherwise set during Blibox configuration)
