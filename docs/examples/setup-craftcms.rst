...
This example will use ``composer`` to install CraftCMS from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-craft
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-craft
   blibox@php-7.0.20 in /shared/httpd/my-craft $ composer create-project craftcms/craft craftcms

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-craft $ tree -L 1
   .
   └── craftcms
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-craft $ ln -s craftcms/web/ htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-craft $ mysql -u root -h 127.0.0.1 -p -e 'CREATE DATABASE my_craft CHARACTER SET utf8 COLLATE utf8_unicode_ci;'
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-craft $ php craftcms/craft setup
