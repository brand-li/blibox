...
3. When starting the Blibox, explicitly specify the service to use and exclude the databases:
...
2. When starting the Blibox, explicitly specify the service to use and exclude the databases:
