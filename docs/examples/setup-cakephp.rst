...
This example will use ``composer`` to install CakePHP from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-cake
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-cake
   blibox@php-7.0.20 in /shared/httpd/my-cake $ composer create-project --prefer-dist cakephp/app cakephp

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-cake $ tree -L 1
   .
   └── cakephp
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-cake $ ln -s cakephp/webroot/ htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-cake $ mysql -u root -h 127.0.0.1 -p -e 'CREATE DATABASE my_cake;'
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-cake $ vi cakephp/config/app.php
