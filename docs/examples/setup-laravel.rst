...
This example will use ``laravel`` to install Laravel from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-laravel
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-laravel
   blibox@php-7.0.20 in /shared/httpd/my-laravel $ laravel new laravel-project

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-laravel $ tree -L 1
   .
   └── laravel-project
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-laravel $ ln -s laravel-project/public/ htdocs
...
``http://my-laravel.loc`` or ``https://my-laravel.loc`` to the Blibox which is listening on
``127.0.0.1``.
