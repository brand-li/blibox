...
This example will use ``composer`` to install Yii from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-yii
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-yii
   blibox@php-7.0.20 in /shared/httpd/my-yii $ composer create-project --prefer-dist --stability=dev yiisoft/yii2-app-basic yii2-dev

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-yii $ tree -L 1
   .
   └── yii2-dev
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-yii $ ln -s yii2-dev/web/ htdocs
