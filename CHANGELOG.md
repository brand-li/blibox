...
Make sure to have a look at [UPDATING](https://github.com/cytopia/blibox/blob/master/UPDATING.md) to see any required steps for updating
major versions.
...
#### Added
- [#686](https://github.com/cytopia/blibox/pull/686) Added documentation for ExpressEngine
...
#### Added
- [#670](https://github.com/cytopia/blibox/issues/670) Add `phalcon` binary to PHP 7.3 and 7.4
- [#664](https://github.com/cytopia/blibox/issues/664) Add PHP `yaml` extension


## Bugfix Release v1.6.1 (2020-01-05)

#### Fixed
- [#662](https://github.com/cytopia/blibox/issues/662) Update to latest Symfony CLI


## Release v1.6.0 (2020-01-04)

#### Changed
- [#642](https://github.com/cytopia/blibox/issues/642) Make email catch-all configurable
- [#265](https://github.com/cytopia/blibox/issues/265) Make SSL vhost settings configurable

#### Added
- [#615](https://github.com/cytopia/blibox/issues/615) Add phpmd
- [#378](https://github.com/cytopia/blibox/issues/378) Allow to mount local `.ssh/` directory into PHP container (read-only)


## Release v1.5.0 (2020-01-03)

#### Added
- [#654](https://github.com/cytopia/blibox/issues/654) Added Opcache Control Panel
...
#### Fixed
- [#618](https://github.com/cytopia/blibox/issues/618) Update Compose version to 2.3
- [#614](https://github.com/cytopia/blibox/issues/614) Update to latest mhsendmail binary with `-o` flag
- [#265](https://github.com/cytopia/blibox/issues/265) Fix http to https redirect for projects

#### Changed
- [#642](https://github.com/cytopia/blibox/issues/642) Be able to disable email catch-all and still run postfix


## Release v1.3.0 (2019-12-29)

#### Fixed
- [#626](https://github.com/cytopia/blibox/issues/626) Cannot create MongoDB database with Adminer
...
#### Fixed
- [#622](https://github.com/cytopia/blibox/issues/622) Certificate Generation Settings
- [#640](https://github.com/cytopia/blibox/issues/640) Mac OS Catalina invalidates virtual host certificates
- [#592](https://github.com/cytopia/blibox/issues/592) sqlsrv connection problem
...
#### Fixed
- [#644](https://github.com/cytopia/blibox/issues/644) Fix GD jpeg support missing in PHP 7.4
- [#619](https://github.com/cytopia/blibox/issues/619) Fix PHP 7.x  WebP support with imagick

#### Added
- Make Ngrok region configurable via `NGROK_REGION` env variable
- [#641](https://github.com/cytopia/blibox/issues/641) Added phpPgAdmin v7 for PHP >=7
- [#594](https://github.com/cytopia/blibox/issues/594) Tool: ghostscript
...
#### Fixed
- [#373](https://github.com/cytopia/blibox/issues/373) Read custom MySQL configuration
- [#540](https://github.com/cytopia/blibox/issues/540) Fix '&' password substitution in mysqldump-secure
- [#209](https://github.com/cytopia/blibox/issues/209) Documentation for Xdebug on Docker for Windows
...
- [#506](https://github.com/cytopia/blibox/issues/506) Documentation improvements for connecting to databases

#### Added
- [#536](https://github.com/cytopia/blibox/issues/536) Added @vue/cli and @vue/cli-service-global



## Release v1.0.0 (2019-03-19)

This is the first major stable release of the Blibox.
...
#### Added
- [CHANGELOG](https://github.com/cytopia/blibox/blob/master/CHANGELOG.md) by the standard of: https://keepachangelog.com
- [UPDATING](https://github.com/cytopia/blibox/blob/master/UPDATING.md) provides information how to update between major versions
- HTTP/2 support
...
- Discourse forum link: https://blibox.discourse.group
