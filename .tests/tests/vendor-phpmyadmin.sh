...
BLIBOX_VENDOR_PHPMYADMIN_AUTOLOGIN="$( "${SCRIPT_PATH}/../scripts/env-getvar.sh" "BLIBOX_VENDOR_PHPMYADMIN_AUTOLOGIN" )"
...
CONFIGPATH="${BLIBOXPATH}/.blibox/www/htdocs${URL%index\.php}config.inc.php"
...
### Autologin disabled
###
if [ "${BLIBOX_VENDOR_PHPMYADMIN_AUTOLOGIN}" != "1" ]; then
