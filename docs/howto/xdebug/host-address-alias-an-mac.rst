...
.. code-block:: bash
   ...
   host> sudo curl -o \
           /Library/LaunchDaemons/org.blibox.docker_10254_alias.plist \
           https://raw.githubusercontent.com/blibox/xdebug/master/osx/org.blibox.docker_10254_alias.plist

   # Enable without reboot
   host> sudo launchctl load /Library/LaunchDaemons/org.blibox.docker_10254_alias.plist

.. seealso::
   * :ref:`configure_php_xdebug`
   * |ext_lnk_github_blibox_xdebug_on_mac|
