...
Ensure you know how to customize ``php.ini`` values for the Blibox and have a rough understanding
...
| Directory                    | Path                                     |
+==============================+==========================================+
| Blibox git directory       | ``/home/cytopia/repo/blibox``          |
+------------------------------+------------------------------------------+
| :ref:`env_httpd_datadir`     | ``./data/www``                           |
+------------------------------+------------------------------------------+
| Resulting local project path | ``/home/cytopia/repo/blibox/data/www`` |
+------------------------------+------------------------------------------+
...
**2. Set path mapping**
   ...
   Create a new PHP server and set a path mapping. This tutorial assumes your local Blibox projects
   to be in ``./data/www`` of the Blibox git directory:
...
Restarting the Blibox is important in order for it to read the new PHP settings.
...
.. seealso:: :ref:`start_the_blibox_stop_and_restart` (Why do ``docker-compose rm``?)
