...
This section will guide you through getting Solr integrated into the Blibox.
...
+------------------------------+-------------------+----------------------------------------------------------------------------+
| ``SOLR_CORE_NAME``           | ``blibox``      | Default Solr core name                                                     |
+------------------------------+-------------------+----------------------------------------------------------------------------+
...
Copy the Solr Docker Compose overwrite file into the root of the Blibox git directory.
...
The final step is to start the Blibox with Solr.
...
.. code-block:: bash
   ...
   echo "SOLR_CORE_NAME=blibox"          >> .env
