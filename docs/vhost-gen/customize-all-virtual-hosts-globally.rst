...
1. Navigate to ``cfg/vhost-gen/`` inside the Blibox directory
2. Copy ``apache22.yml-example-vhost`` to ``apache22.yml`` and restart the Blibox
3. Whenever you adjust ``apache22.yml``, you need to restart the Blibox
...
1. Navigate to ``cfg/vhost-gen/`` inside the Blibox directory
2. Copy ``apache24.yml-example-vhost`` to ``apache24.yml`` and restart the Blibox
3. Whenever you adjust ``apache24.yml``, you need to restart the Blibox
...
1. Navigate to ``cfg/vhost-gen/`` inside the Blibox directory
2. Copy ``nginx.yml-example-vhost`` to ``nginx.yml`` and restart the Blibox
3. Whenever you adjust ``nginx.yml``, you need to restart the Blibox
