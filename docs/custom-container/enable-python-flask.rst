...
This section will guide you through getting Python Flask integrated into the Blibox.
...
| Exposed port          | none                                                                                                     |
+-----------------------+----------------------------------------------------------------------------------------------------------+
| Available at          | Blibox intranet via Reverse Proxy configuration                                                        |
+-----------------------+----------------------------------------------------------------------------------------------------------+
...
Copy the Python Flask Docker Compose overwrite file into the root of the Blibox git directory.
...
Before starting up the blibox you will need to configure your python flask project and the
