...
.. include:: /_includes/figures/blibox/blibox-intranet-vhosts-empty.rst


Step 2: create a project directory
==================================

In your Blibox git directory, navigate to ``./data/www`` and create a new directory.
...
.. code-block:: bash
   ...
   # navigate to your Blibox git directory
...
.. include:: /_includes/figures/blibox/blibox-intranet-vhosts-missing-htdocs.rst
...
.. include:: /_includes/figures/blibox/blibox-intranet-vhosts-missing-dns.rst
...
When using native Docker, the Blibox intranet will provide you the exact string you need to paste
...
.. include:: /_includes/figures/blibox/blibox-intranet-vhosts-working.rst

**So what has happened?**

By having created the DNS record, the Blibox intranet is aware that everything is setup now and
...
.. include:: /_includes/figures/blibox/blibox-project-missing-index.rst
...
.. include:: /_includes/figures/blibox/blibox-project-hello-world.rst
...
If you already want to know how to setup specific frameworks on the Blibox, jump directly to
their articles:

.. seealso::

   **Well tested frameworks on the Blibox**
