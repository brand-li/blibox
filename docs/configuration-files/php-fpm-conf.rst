...
.. code-block:: bash
   ...
   host> ls -l path/to/blibox/cfg/ | grep 'php-fpm'
...
``blibox-fpm.conf-default``, ``blibox-fpm.conf-pm_dynamic`` and ``blibox-fpm.conf-pm_ondemand``.

**blibox-fpm.conf-default**
