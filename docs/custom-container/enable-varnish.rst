...
This section will guide you through getting Varnish integrated into the Blibox.
...
Copy the Varnish Docker Compose overwrite file into the root of the Blibox git directory.
...
The final step is to start the Blibox with Varnish.
