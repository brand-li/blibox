...
This example will use ``wget`` to install Joomla from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-joomla
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-joomla
   blibox@php-7.0.20 in /shared/httpd/my-joomla $ wget -O joomla.tar.gz https://downloads.joomla.org/cms/joomla3/3-8-0/joomla_3-8-0-stable-full_package-tar-gz?format=gz
   blibox@php-7.0.20 in /shared/httpd/my-joomla $ mkdir joomla
   blibox@php-7.0.20 in /shared/httpd/my-joomla $ tar xvfz joomla.tar.gz -C joomla/

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-joomla $ tree -L 1
   .
   ├── joomla.tar.gz
   └── joomla
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-joomla $ ln -s joomla/ htdocs
