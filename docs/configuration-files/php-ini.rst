...
.. code-block:: bash
   ...
   host> ls -l path/to/blibox/cfg/ | grep 'php-ini'
...
``blibox-php.ini-default`` and ``blibox-php.ini-xdebug``.

**blibox-php.ini-default**
...
You can validate that the changes have taken place by visiting the Blibox intranet phpinfo page.
