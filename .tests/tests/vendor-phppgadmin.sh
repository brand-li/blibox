...
BLIBOX_VENDOR_PHPPGADMIN_AUTOLOGIN="$( "${SCRIPT_PATH}/../scripts/env-getvar.sh" "BLIBOX_VENDOR_PHPPGADMIN_AUTOLOGIN" )"
...
BLIBOXPATH="${SCRIPTPATH}/../../"
CONFIGPATH="${BLIBOXPATH}/.blibox/www/htdocs${URL%index\.php}conf/config.inc.php"
LIBPATH="${BLIBOXPATH}/.blibox/www/htdocs${URL%index\.php}libraries/lib.inc.php"
...
### Autologin disabled
###
if [ "${BLIBOX_VENDOR_PHPPGADMIN_AUTOLOGIN}" != "1" ]; then
