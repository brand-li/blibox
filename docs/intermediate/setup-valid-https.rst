...
This page shows you how to use the Blibox on https and how to import the Certificate Authority
...
.. code-block:: bash
   ...
   host> ls -l ca/
   -rw-r--r--  1 cytopia cytopia 1558 May  2 11:12 blibox-ca.crt
   -rw-------  1 cytopia cytopia 1675 May  2 11:12 blibox-ca.key
   -rw-r--r--  1 cytopia cytopia   17 May  4 08:35 blibox-ca.srl
...
4. **The SSL certificate is signed by the Blibox Certificate Authority**
...
.. important::
   Importing the CA into the browser is also recommended and required for the Blibox
...
Select ``blibox-ca.crt`` from within the Blibox ``./ca`` directory:
...
.. seealso:: ``.env`` variable: :ref:`env_blibox_ui_ssl_cn`
