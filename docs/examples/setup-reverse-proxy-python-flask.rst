...
The following Blibox configuration is required:
...
.. seealso:: Available Python versions can be seen here: https://github.com/blibox/docker-python-flask
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-flask
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-flask

   # Create a directory which will hold the source code
   blibox@php-7.0.20 in /shared/httpd/my-flask $ mkdir app

   # Create the main.py file with your favourite editor
   blibox@php-7.0.20 in /shared/httpd/my-flask/app $ vi main.py
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-flask $ vi requirements.txt
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-flask $ ln -s app htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-flask $ mkdir .blibox
...
For this example we will copy all ``*-example-rproxy`` files into ``data/www/my-flask/.blibox/``
(Inside container: ``/shared/httpd/my-flask/.blibox``) to ensure this will work with all web servers.

.. code-block:: bash

   host> cd /path/to/blibox
   host> cp cfg/vhost-gen/apache22.yml-example-rproxy data/www/my-flask/.blibox/apache22.yml
   host> cp cfg/vhost-gen/apache24.yml-example-rproxy data/www/my-flask/.blibox/apache24.yml
   host> cp cfg/vhost-gen/nginx.yml-example-rproxy data/www/my-flask/.blibox/nginx.yml
...
.. code-block:: bash
   ...
   host> cd /path/to/blibox
   host> vi data/www/my-flask/.blibox/apache22.yml
...
.. code-block:: yaml
   :caption: data/www/my-flask/.blibox/apache22.yml
...
.. code-block:: bash
   ...
   host> cd /path/to/blibox
   host> vi data/www/my-flask/.blibox/apache24.yml
...
.. code-block:: yaml
   :caption: data/www/my-flask/.blibox/apache24.yml
   :emphasize-lines: 16,17
...
.. code-block:: bash
   ...
   host> cd /path/to/blibox
   host> vi data/www/my-flask/.blibox/nginx.yml


Find the lines with ``proxy_pass`` and change the port from ``8000`` to ``3000``

.. code-block:: yaml
   :caption: data/www/my-flask/.blibox/nginx.yml
   :emphasize-lines: 18
...
Python Flask comes with its own Docker container and can be added to the Blibox stack via
