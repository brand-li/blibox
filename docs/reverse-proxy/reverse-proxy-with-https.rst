...
For this example we will copy all ``*-example-rproxy`` files into ``/shared/httpd/my-app/.blibox``
to ensure this will work with all web servers.

.. code-block:: bash

   host> cd /path/to/blibox
   host> cp cfg/vhost-gen/apache22.yml-example-rproxy data/www/my-app/.blibox/apache22.yml
   host> cp cfg/vhost-gen/apache24.yml-example-rproxy data/www/my-app/.blibox/apache24.yml
   host> cp cfg/vhost-gen/nginx.yml-example-rproxy data/www/my-app/.blibox/nginx.yml
...
.. code-block:: bash
   ...
   host> cd /path/to/blibox
   host> vi data/www/my-app/.blibox/apache22.yml
...
.. code-block:: yaml
   :caption: data/www/my-app/.blibox/apache22.yml
...
.. code-block:: bash
   ...
   host> cd /path/to/blibox
   host> vi data/www/my-app/.blibox/apache24.yml
...
.. code-block:: yaml
   :caption: data/www/my-app/.blibox/apache24.yml
   :emphasize-lines: 16,17
...
.. code-block:: bash
   ...
   host> cd /path/to/blibox
   host> vi data/www/my-app/.blibox/nginx.yml


Find the lines with ``proxy_pass`` and change the port from ``8000`` to ``8081``

.. code-block:: yaml
   :caption: data/www/my-app/.blibox/nginx.yml
   :emphasize-lines: 18
...
.. code-block:: bash
   ...
   # Start the Blibox (PHP and HTTPD container only)
