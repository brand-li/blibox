...
**4. Shared volumes:**
   ...
   Ensure all your Blibox data (Blibox directory and project directory) are within the volumes
...
.. seealso::
   * https://github.com/cytopia/blibox/issues/539
...
of the affected service in the Blibox ``.env`` file.
...
.. seealso:: https://github.com/cytopia/blibox/issues/223


localhost or 127.0.0.1 not found
--------------------------------

If you are using Docker Toolbox, the Blibox intranet is not available on localhost or 127.0.0.1,
...
.. seealso::
   * :ref:`install_the_blibox_osx_performance`
...
.. code-block:: bash
   ...
   bind_1 | /etc/bind/blibox-wildcard_dns.localhost.conf:1:
   zone 'localhost': already exists previous definition:
...
.. seealso::
   ...
   * :ref:`env_tld_suffix`
   * https://github.com/cytopia/blibox/issues/291
...
resolution to the Blibox's PHP container IP address.
...
.. seealso::
   ...
   * :ref:`env_tld_suffix`
   * https://github.com/cytopia/blibox/issues/275
...
This error might occur for the Blibox intranet or custom created projects.
...
For the Blibox intranet, ensure the ``.blibox/`` directory is readable for users, groups and
...
This might additionally occur on MacOS or Windows due to the Blibox and/or its projects not
being in the standard location of Docker Shared volumes.

Check your Docker settings to allow shared volumes for the path of the Blibox and its projects.
...
.. seealso::
   ...
   * :ref:`env_httpd_timeout_to_php_fpm`
   * https://github.com/cytopia/blibox/issues/280
   * https://github.com/cytopia/blibox/issues/234
...
.. seealso:: https://github.com/cytopia/blibox/issues/542
...
This warning might occur when using :ref:`howto_docker_toolbox_and_the_blibox` on Windows and
...
.. code-block:: bash
   ...
   # Nagivate to blibox git directory
   host> cd path/to/blibox
...
.. seealso::
   * :ref:`my_cnf`
   * https://github.com/cytopia/blibox/issues/212
...
.. seealso:: For detailed example see here:
  ...
  * Docker Toolbox on Windows: :ref:`howto_docker_toolbox_and_the_blibox_windows_symlinks`
