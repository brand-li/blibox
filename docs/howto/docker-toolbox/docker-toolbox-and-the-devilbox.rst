...
.. _howto_docker_toolbox_and_the_blibox:

*******************************
Docker Toolbox and the Blibox
*******************************
...
However, there are a few stumbling blocks you need to pay attention to in order to use the Blibox
...
Blibox listening address configuration
========================================
...
The Blibox intranet will not be available under ``127.0.0.1`` or ``localhost`` as it does not run
...
.. _howto_docker_toolbox_and_the_blibox_windows_symlinks:
...
.. seealso::
   ...
   * https://github.com/cytopia/blibox/issues/479
