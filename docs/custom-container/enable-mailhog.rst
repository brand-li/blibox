...
This section will guide you through getting MailHog integrated into the Blibox.
...
Copy the MailHog Docker Compose overwrite file into the root of the Blibox git directory.
...
The final step is to start the Blibox with MailHog.
...
* Once the Blibox is running, visit http://localhost:8025 in your browser.
* Any email send by any of the Blibox managed projects will then appear in MailHog
