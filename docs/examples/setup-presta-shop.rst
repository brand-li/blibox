...
This example will use ``git`` and ``composer`` to install PrestaShop from within the Blibox
PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-presta
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-presta

   # Download PrestaShop with git
   blibox@php-7.0.20 in /shared/httpd/my-presta $ git clone https://github.com/PrestaShop/PrestaShop

   # Checkout the latest stable git tag
   blibox@php-7.0.20 in /shared/httpd/my-presta $ cd PrestaShop
   blibox@php-7.0.20 in /shared/httpd/my-presta $ git checkout 1.7.4.2

   # Install dependencies with Composer
   blibox@php-7.0.20 in /shared/httpd/my-presta $ composer install

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-presta $ tree -L 1
   .
   └── PrestaShop
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-presta $ ln -s PrestaShop/ htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-presta $ mysql -u root -h 127.0.0.1 -p -e 'CREATE DATABASE my_presta;'
