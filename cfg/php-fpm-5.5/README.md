...
| File                            | Description                                 |
|---------------------------------|---------------------------------------------|
| `blibox-fpm.conf-default`     | Represents current PHP-FPM default settings |
| `blibox-fpm.conf-pm_dynamic`  | Example settings for dynamic workers        |
| `blibox-fpm.conf-pm_ondemand` | Example settings for ondemand workers       |
