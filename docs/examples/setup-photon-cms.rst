...
This example will use ``photon`` cli to install Photon CMS from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-photon
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-photon
   blibox@php-7.0.20 in /shared/httpd/my-photon $ photon new blog
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-photon $ tree -L 1
   .
   └── blog
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-photon $ ln -s blog/public/ htdocs
