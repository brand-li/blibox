...
This example will use ``git`` to install Shopware from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ mkdir my-sw
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd $ cd my-sw
   blibox@php-7.0.20 in /shared/httpd/my-sw $ git clone https://github.com/shopware/shopware

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.0.20 in /shared/httpd/my-sw $ tree -L 1
   .
   └── shopware
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-sw $ ln -s shopware/ htdocs
...
.. code-block:: bash
   ...
   blibox@php-7.0.20 in /shared/httpd/my-sw $ mysql -u root -h 127.0.0.1 -p -e 'CREATE DATABASE my_sw;'
...
.. seealso:: https://github.com/cytopia/blibox/issues/300
