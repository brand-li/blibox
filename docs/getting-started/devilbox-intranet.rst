...
The Blibox intranet is your command & control center showing all kinds of information and
...
.. include:: /_includes/figures/blibox/blibox-intranet-index.rst
...
.. include:: /_includes/figures/blibox/blibox-intranet-vhosts.rst
...
.. include:: /_includes/figures/blibox/blibox-intranet-emails.rst
...
.. include:: /_includes/figures/blibox/blibox-intranet-mysql-databases.rst
...
.. include:: /_includes/figures/blibox/blibox-intranet-php-info.rst

The following example shows you the info page for MySQL:

.. include:: /_includes/figures/blibox/blibox-intranet-mysql-info.rst


Third-party tools
=================

.. _blibox_intranet_adminer:
...
.. _blibox_intranet_phpmemcachedadmin:
...
If you share your projects over a LAN, but do not want anybody to view the Blibox intranet,
you can also password protect it.

.. seealso::
   In order to do so, have a look at the following ``.env`` variables:

   * :ref:`env_blibox_ui_protect`
   * :ref:`env_blibox_ui_password`


Disable the intranet
--------------------

If you want a more production-like setup, you can also fully disable the Blibox intranet.
...
.. seealso::
   ...
   * :ref:`env_blibox_ui_enable`


Checklist
=========

1. You know what tools are provided by the Blibox intranet
2. You know how to password protect the Blibox intranet
3. You know how to disable the Blibox intranet
