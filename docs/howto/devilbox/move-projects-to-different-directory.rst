...
the Blibox git directory now, you can do that in a few simple steps.
...
Now you decide to use the Blibox, but still want to keep your projects where they are at the
moment.
...
That's it, whenever you start up the Blibox, ``/home/user/workspace/web/`` will be mounted into
the PHP and the web server container into ``/shared/httpd/``.


Projects adjacent to Blibox directory
=======================================
...
Independently of where the Blibox directory is located, you can achieve this structure via
...
That's it, whenever you start up the Blibox, your project directory will be mounted into
the PHP and the web server container into ``/shared/httpd/``.
