...
**********************
Blibox documentation
**********************

|img_banner|

The Blibox is a modern dockerized LAMP and MEAN stack for local development on Linux, MacOS
and Windows.
...
.. raw:: html
   ...
   <img src="https://raw.githubusercontent.com/blibox/artwork/master/submissions_diagrams/cytopia/01/png/architecture-full.png" />
...
.. toctree::
   ...
   getting-started/install-the-blibox
   getting-started/start-the-blibox
   getting-started/blibox-intranet
...
.. toctree::
   ...
   corporate-usage/shared-blibox-server-in-lan
   corporate-usage/use-external-databases
   corporate-usage/showcase-over-the-internet
..
   corporate-usage/deploy-blibox-via-ansible
   corporate-usage/access-colleagues-blibox
   corporate-usage/access-blibox-from-android
   corporate-usage/access-blibox-from-iphone
...
.. toctree::
   ...
   maintenance/checkout-different-blibox-release
   maintenance/remove-stopped-container
   maintenance/update-the-blibox
   maintenance/remove-the-blibox
...
.. toctree::
   ...
   Blibox Forums <https://blibox.discourse.group/>
