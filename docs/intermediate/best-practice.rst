...
If you have already operate the Blibox, this guide is a must have. It will cover common
...
Move data out of Blibox directory
===================================

One thing you should take into serious consideration is to move data such as your projects as well
as persistent data of databases out of the Blibox git directory.

The Blibox git directory should be something that can be safely deleted and re-created without
...
.. seealso::
   :ref:`howto_move_projects_to_a_different_directory`
     Follow this guide to keep your projects separated from the Blibox git directory.
...
In case of the Blibox ``.env`` file, just store this file in your repository and symlink it to
the Blibox git directiry. This way you make sure that you keep your file, even when the Blibox
...
You would then simply symlink one of those files to the Blibox git directory.


Version control service config files
------------------------------------

.. todo:: This will require some changes on the Blibox and will be implemented shortly.
...
however not affect any other official Docker container that are used within the Blibox. This is
