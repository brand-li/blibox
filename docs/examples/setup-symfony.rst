...
This example will use ``symfony`` to install Symfony from within the Blibox PHP container.
...
.. code-block:: bash
   ...
   blibox@php-7.2.29 in /shared/httpd $ mkdir my-symfony
...
.. code-block:: bash
   ...
   blibox@php-7.2.29 in /shared/httpd $ cd my-symfony
   blibox@php-7.2.29 in /shared/httpd/my-symfony $ symfony new symfony

How does the directory structure look after installation:

.. code-block:: bash

   blibox@php-7.2.29 in /shared/httpd/my-symfony $ tree -L 1
   .
   └── symfony
...
.. code-block:: bash
   ...
   blibox@php-7.2.29 in /shared/httpd/my-symfony $ ln -s symfony/public/ htdocs

How does the directory structure look after symlinking:

.. code-block:: bash

   blibox@php-7.2.29 in /shared/httpd/my-sw $ tree -L 1
   .
   ├── symfony
